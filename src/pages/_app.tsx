  ...
  return (
    <div className='w-2/12 border fixed top-0 bottom-0 p-2 px-4 bg-slate-800'>
      ...
      <Box className='my-8 overflow-y-auto h-full'>
        <NavItem count={'5'} name={'Navbar'} link={'/navbar'} />
        <NavItem count={'2'} name={'Call To Action'} link={'/call-to-action'} />
        ...
        <NavItem count={'6'} name={'Blog'} link={'/blog'} />
...
const NavItem = ({ count, link, name }: INavitem) => {
  return (
    <Link href={link} className='p-2 text-white w-full flex justify-between hover:bg-slate-600 rounded-md'>
